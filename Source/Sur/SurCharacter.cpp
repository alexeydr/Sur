...
void ASurCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ASurCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ASurCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASurCharacter::OnResetVR);
}


void ASurCharacter::OnResetVR()
{
	// If Sur is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Sur.Build.cs is not automatically propagated
...
void ASurCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ASurCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
